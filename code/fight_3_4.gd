...
var enemyHP = 150
var enemyCurrentHP = 150
var enemySP = 300
var enemyCurrentSP = 300
var enemyAtk = 25
var enemyDef = 15
var enemySpd = 17
var enemyCrit = 25
...
var boss_dialogue_lines: Array[String] = [
	...
	"Oh, pardon the tears on my robe.", 
	"They're from prior battles.",
	"I'm more of an electrical arts user.", 
	"so to speak. ",
	"The corporation hired me for one reason.", 
	"I'm the best at sniffing traitors out.",
	"And now my arts tell me...", 
	"Traitor, this is where your long journey ends!",
]
...
func enemy_attack():
	...
	if enemyCurrentHP <= 0:
		...
		Global.world += 1
		Global.level = 1
		show_general_dialogue("...You've... not... won...")
