...
var enemyHP = 250
var enemyCurrentHP = 250
var enemySP = 200
var enemyCurrentSP = 200
var enemyAtk = 33
var enemyDef = 33
var enemySpd = 33
var enemyCrit = 33
...
var boss_dialogue_lines: Array[String] = [
	"So... you've arrived.",
	"The young cadet,", 
	"the best we've had in our civilization's time.",
	"The one who defeated all these troops", 
	"with a ragtag group of half-wits and humans.",
	"I can tell you know the full details. ", 
	"Our civilization was on the brink of extinction back on...",
	"Earth, we'll call it.", 
	"We were in despair. We had nowhere to go...",
	"so we thought. Space travel advanced rapidly.",
	"We eventually made our way across galaxies,", 
	"using all the planets had to offer to us.",
	"We up and left and took new planets for eons...", 
	"I was hoping now, with one trillion years to heal,",
	"that the Earth could be ours once again. ", 
	"Yet, you sympathize with the enemy.",
	"I can't let you continue. This ends now.", 
	" We will have this world... and all in it.",
]
...
func enemy_attack():
	...
	if enemyCurrentHP <= 0:
		Global.ip += 1
		show_general_dialogue("Heh... guess I couldn't stop fate. You and your morality...")
		await get_tree().create_timer(1.5).timeout
		show_general_dialogue("I suppose it's what made us so advanced to begin with.")
		await get_tree().create_timer(1.5).timeout
		show_general_dialogue("Our people are finished. ...is this what we deserve?")
		await get_tree().create_timer(1.5).timeout
